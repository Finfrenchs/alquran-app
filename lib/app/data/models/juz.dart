//URL API https://api.quran.gading.dev/juz/1
//get juz in the Al-Quran
...
class Juz {
  ...
  factory Juz.fromJson(Map<String, dynamic>? json) => Juz(
        ...
        //juzEndSurahNumber: json?['juzEndSurahNumber'], //ERROR (type 'string' is not a subtype of type 'int' of 'index)
